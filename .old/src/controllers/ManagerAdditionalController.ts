...
export class ManagerAdditionalController extends AppContext {
  ...
  public static index = ManagerAdditionalController._index.bind(ManagerAdditionalController);
  public static show = ManagerAdditionalController._show.bind(ManagerAdditionalController);
  public static store = ManagerAdditionalController._store.bind(ManagerAdditionalController);
  public static update = ManagerAdditionalController._update.bind(ManagerAdditionalController);
  public static destroy = ManagerAdditionalController._destroy.bind(ManagerAdditionalController);
}
