...
export class ManagerCompanyController extends AppContext {
  ...
  public static async _store(request: Request, response: Response) {
    ...
    const { value: body, error } = Joi.object<ICreateBody>({
      ...
      businessHours: Joi.array()
        ...
        .length(7)
        .required(),
    }).validate({ ...request.body, businessHours: JSON.parse(request.body.businessHours) });
  ...
  public static index = ManagerCompanyController._index.bind(ManagerCompanyController);
  public static show = ManagerCompanyController._show.bind(ManagerCompanyController);
  public static store = ManagerCompanyController._store.bind(ManagerCompanyController);
  public static update = ManagerCompanyController._update.bind(ManagerCompanyController);
  public static destroy = ManagerCompanyController._destroy.bind(ManagerCompanyController);
}
