...
export class ManagerMenuController extends AppContext {
  ...
  public static index = ManagerMenuController._index.bind(ManagerMenuController);
  public static show = ManagerMenuController._show.bind(ManagerMenuController);
  public static store = ManagerMenuController._store.bind(ManagerMenuController);
  public static update = ManagerMenuController._update.bind(ManagerMenuController);
  public static destroy = ManagerMenuController._destroy.bind(ManagerMenuController);
}
