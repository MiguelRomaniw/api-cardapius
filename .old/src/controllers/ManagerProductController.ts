...
import { Additional, AdditionalGroup, Category, Product } from "Src/database/entities";
...
import { ProductStatus, ProductStatuses } from "Src/types/ProductStatus";
...
export class ManagerProductController extends AppContext {
  ...
  public static index = ManagerProductController._index.bind(ManagerProductController);
  public static show = ManagerProductController._show.bind(ManagerProductController);
  public static store = ManagerProductController._store.bind(ManagerProductController);
  public static update = ManagerProductController._update.bind(ManagerProductController);
  public static destroy = ManagerProductController._destroy.bind(ManagerProductController);
}
